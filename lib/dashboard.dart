            ...
            child: Column(
              ...
              children: [
                ...
                Stack(
                  children: [
                    Padding(
                      padding: EdgeInsetsDirectional.fromSTEB(20, 29, 20, 0),
                      child: Container(
                ...
                Row(
                  ...
                  children: [
                    Container(
                      ...
                      height: 250,
                      decoration: BoxDecoration(
                        color: Color.fromARGB(255, 53, 102, 239),
                        borderRadius: BorderRadius.circular(10),
                      ),
                      // child: Column(
                      //   mainAxisSize: MainAxisSize.max,
                      ...
                      children: [
                        Padding(
                          ...
                          child: Container(
                            ...
                            height: 120,
                            decoration: BoxDecoration(
                              color: Color.fromRGBO(41, 213, 202, 0.55),
                              borderRadius: BorderRadius.circular(10),
                            ),
                            child: Column(
                              mainAxisSize: MainAxisSize.max,
                ...
                Padding(
                  padding: EdgeInsetsDirectional.fromSTEB(25, 15, 25, 20),
                  child: Container(
                    height: 115,
                    ...
                    decoration: BoxDecoration(
                      ...
                      color: Color.fromARGB(255, 248, 194, 113),
                    ),
                    child: Column(
                      mainAxisSize: MainAxisSize.max,
                      children: [
